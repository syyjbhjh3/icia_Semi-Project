...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
  ...
  <body class="align">
  	<div class="backgroundTransition">
	    <h2 style="color: white">C:C</h2>
	    <p style="color: white">[Catch:Cash]</p>
    ...
    <div class="grid__container">
      ...
      <form action="login" method="post" class="form form--login">
        ...
        <div class="form__field">
          <label class="fontawesome-user" for="login__username"><font >ID</font><span class="hidden">Username</span></label>
        ...
        <div class="form__field">
        <a  style="margin-left:25%;" href="joinForm.jsp">회원가입</a><a style="margin-left:5%;" href="findId.jsp">ID,PW찾기</a>
        </div>
      </form>
