    ...
    <body>
    	...
    	<div id="resistdiv">
    		...
    		<tr>
	    		...
	    		<input type="date" name="budgetstart" id="datestart"/>~<input type="date" name="budgetend" />
	    		</td>
	    		<td>
	    		예산액:
	    		<input type="text" name="budgetm" style="text-align:center; width:120px;"/>
	    		
	    		<input type="button" value="예산등록" onclick="budgetSubmit(1)"/>
	    		</td>
	    	</tr>
        	...
        	<tr>
        		...
        		<td> 
        			<input type="text" name="price" style="text-align:center; width:120px;"/>
        		</td>
        	</tr>
        	</table>
        ...
        -->
        <br/>
        	<div id="list" style="height:44.5%; overflow:auto;">
