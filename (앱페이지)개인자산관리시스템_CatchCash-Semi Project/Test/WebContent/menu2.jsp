...
<body>
	...
	<div id="slatenav">
	<ul>
	<li><a href="seelistidx?user_id=${sessionScope.loginId }" title="css menus" class="current" id="menu1">일별보기</a></li>
	<li><a href="monthpay.jsp" title="css menus" id="menu2">월별보기</a></li>
	<li><a href="categorylist" title="css menus" id="menu3">분야별 보기</a></li>
	</ul>
	</div>
	</div>
