...
<body>
	...
	<header id="header">
		<div class="drawer-toggle" onclick="setOpened()"><i class="ic-menu"><img src="menu.png" width="96" height="50"  style="margin-top:20%;margin-left:-15%;" alt=""></i></div>
		<b id="ssibal"><a id="cc" href="mainlist">Catch Cash</a></b>
	</header>
	...
	<nav id="drawer">
      ...
      <li> <a href="calrendar"><i class="fa fa-fw fa-folder"></i>캘린더</a> </li>
      <li> <a href="tooja.jsp"><i class="fa fa-fw fa-file-o"></i>저축상품 찾기</a> </li>
      <li> <a href='seelistidx?user_id=${sessionScope.loginId }'><i class="fa fa-fw fa-cog"></i>수입 및 지출 상세보기</a></li>
      <li> <a href="board"><i class="fa fa-fw fa-cog"></i>정보 나눔 게시판</a> </li>
      </ul>
    <div id="logo">
	<img src="image\로고.png" width = "72px" height ="72px" />Catch Cash
	</div>
	<div id="logoa" style="position: absolute; top:635px;">
		ICIA</br>
		서울특별시 강남구 청담동 892-69</br>
		고기빈 권혁준 박영준 유성환
	</div>
