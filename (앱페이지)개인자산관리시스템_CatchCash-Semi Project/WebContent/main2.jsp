    ...
    <body>
    	...
    	<form name="myForm" method="post">
    		...
    		<tr>
	    		...
	    		<span>시작일: <input type="date" name="budgetstart" id="datestart"/><br/>
	    		종료일: <input type="date" name="budgetend" /></span>
	    		</td>
	    		<td>
	    		예산액:
        	...
        	<tr>
        		<td colspan="2"><input id="resister" type="button" value ="가계부등록" onclick="budgetSubmit(3)"/></td>
        	</tr>
        	</table>
        	</form>
        </div>
