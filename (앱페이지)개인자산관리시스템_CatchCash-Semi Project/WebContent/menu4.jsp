...
.blue #slatenav ul li a{display:block;float:left;color:#D5F1FF;text-decoration:none;padding:14px 55px 0 58px;height:28px;}
...
<body>
	...
	<li id="two" ><a href="monthpay.jsp" title="css menus">월별</a></li>
	<li id="three"><a href="categorylist" title="css menus" class="current">분야별</a></li>
