...
<html>
  ...
  <body class="align">
    ...
    <div class="grid__container">
      ...
      <form action="modify" method="post" name="frm" class="form form--login">
      	<div style="margin-top:40%;">
		<div class="form__field" style="float:left;width:50%;">
          <input type="button" onclick="location.href='findId.jsp'"  value="Find ID">
        </div><div class="form__field" >  
          <input type="button" onclick="location.href='findpw.jsp'" id="findidbtn" value="Find PW">
        </div>
        </div>
        <div class="form__field">
          <label class="fontawesome-user" for="login__username"><font ></font><span class="hidden">New Password</span></label>
          <input id="login__username" type="password" class="form__input" name="userPw" placeholder="New Password" required>
        </div>
        
        <div class="form__field">
          <label class="fontawesome-user" for="login__username"><font ></font><span class="hidden">New Password</span></label>
          <input id="login__username" type="password" class="form__input" name="userRPw" placeholder="New Password Check" required>
        </div>

        <div class="form__field">
          <input type="submit" value="Check" onclick="checking()"/>
        </div>
	<jsp:include page="pwloginbox.jsp"></jsp:include>
      </form>
    ...
    function checking(){
		if(document.frm.userPw.value != document.frm.userRPw.value){
			alert("비밀번호가 같지 않습니다.");
			document.frm.userRPw.value = "";
			return false;
		}
	}
