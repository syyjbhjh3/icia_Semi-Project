    ...
    <div class="grid__container">
      ...
      <form action="join" method="post" name="frm" class="form form--login">
        ...
        <div class="form__field" style="margin-top:-20%;">
          <label class="fontawesome-user" for="login__username" style="margin-right: -2%;"><span class="hidden">UserId</span></label>
          <input id="login__username" type="text" class="form__input" name="userId" placeholder="UserId" value="${id }" required>
		        <button name="check" onclick="Idcheck(1)">중복확인</button>
		          
        </div>
        
        <div class="form__field" >
          <label class="fontawesome-user" for="login__username" style="margin-right: -2%;"><font ></font><span class="hidden">Username</span></label>
          <input id="login__username" type="text" class="form__input" name="userName" value="${name }" placeholder="Username" required>
        </div>

        <div class="form__field">
          <label class="fontawesome-lock" for="login__password" style="margin-right: -2%"><span class="hidden">Password</span></label>
          <input id="login__password" type="password" name="userPw" class="form__input" value="${pw }" placeholder="Password" required>
        </div>
        
        <div class="form__field">
          <label class="fontawesome-lock" for="login__password" style="margin-right: -2%"><font></font><span class="hidden">Password</span></label>
          <input id="login__password" type="password" name="Pwcheck"" class="form__input" value="${rpw }" placeholder="Password Check" required>
        </div>
        
        <div class="form__field">
          <label class="fontawesome-lock" for="login__password" style="margin-right: -2%"><font></font><span class="hidden">E-Mail</span></label>
          <input id="login__password" type="text" name="email" class="form__input" value="${email }" placeholder="E-Mail" required>
        </div>
         ...
         <div class="form__field">
          ...
          <div class="spanman">
          <input type="radio" name="human" value="man" class="form__input" checked/>남자
          <input type="radio" name="human" value="woman" style="margin-left: 5%;" />여자
          </div>
          </span></div>
          ...
          <div class="form__field" >
         	...
         	<input type="date" name="birthday" value="${birth }" style="color: black;"/>
         	</div>
          </span>
        </div>
        ...
        <div class="form__field">
          ...
          <span id="login__password"  class="form__input">
           ...
           <select name="number">
                    ...
                    <input type="Number" name="fowNum" value="${fownumber }" style="width : 90px; color: black;"/>-
                    <input type="Number" name="backNum" value="${backnumber }" style="width : 90px; color: black;"/>
                    </div>
          </span>
        </div>
        ...
        <input type="hidden" value="${count}" name="count"/>
          <input type="button" onclick="checking()"  value="Regist">
        </div>
        <div class="form__field">  
